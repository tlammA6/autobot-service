    ...
    let intentParams = [
        
        {
            ...
            "confirmationPrompt": {
                ...
                "messages": [
                    {
                        "content": "{firstName}, please wait while we bring up your account...", 
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "May I please have your first name?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
                ...
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "May I please have your last name?",
                                "contentType": "PlainText"
                            }
                        ]
                    }
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "678ff479",
